...
<head>
    ...
    <!-- Here we give the same css of index because both is for sign in, just Heading text means some text is changed -->
...
<body>
    ...
    <div class="main" >
        ...
        <div class="content">
            ...
            <div class="text">
                <h1>You Need To <br><span>Log In First</span> </h1>
